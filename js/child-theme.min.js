...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(t,e){t.exports=function(t,e,i,n){const s=t=>t&&"object"==typeof t&&"default"in t?t:{default:t},o=s(e),r=s(i),a=s(n),l="tab",c=".bs.tab",u=`hide${c}`,d=`hidden${c}`,f=`show${c}`,h=`shown${c}`,p=`click${c}`,g=`keydown${c}`,m=`load${c}`,_="ArrowLeft",b="ArrowRight",v="ArrowUp",y="ArrowDown",w="active",E="fade",x="show",A="dropdown",T=".dropdown-toggle",C=".dropdown-menu",O=":not(.dropdown-toggle)",L='.list-group, .nav, [role="tablist"]',k=".nav-item, .list-group-item",D='[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',S=`.nav-link${O}, .list-group-item${O}, [role="tab"]${O}, ${D}`,P=`.${w}[data-bs-toggle="tab"], .${w}[data-bs-toggle="pill"], .${w}[data-bs-toggle="list"]`;class j extends a.default{constructor(t){super(t),this._parent=this._element.closest(L),this._parent&&(this._setInitialAttributes(this._parent,this._getChildren()),o.default.on(this._element,g,(t=>this._keydown(t))))}static get NAME(){return l}show(){const t=this._element;if(this._elemIsActive(t))return;const e=this._getActiveElem(),i=e?o.default.trigger(e,u,{relatedTarget:t}):null;o.default.trigger(t,f,{relatedTarget:e}).defaultPrevented||i&&i.defaultPrevented||(this._deactivate(e,t),this._activate(t,e))}_activate(e,i){if(!e)return;e.classList.add(w),this._activate(t.getElementFromSelector(e));const n=()=>{"tab"===e.getAttribute("role")?(e.removeAttribute("tabindex"),e.setAttribute("aria-selected",!0),this._toggleDropDown(e,!0),o.default.trigger(e,h,{relatedTarget:i})):e.classList.add(x)};this._queueCallback(n,e,e.classList.contains(E))}_deactivate(e,i){if(!e)return;e.classList.remove(w),e.blur(),this._deactivate(t.getElementFromSelector(e));const n=()=>{"tab"===e.getAttribute("role")?(e.setAttribute("aria-selected",!1),e.setAttribute("tabindex","-1"),this._toggleDropDown(e,!1),o.default.trigger(e,d,{relatedTarget:i})):e.classList.remove(x)};this._queueCallback(n,e,e.classList.contains(E))}_keydown(e){if(![_,b,v,y].includes(e.key))return;e.stopPropagation(),e.preventDefault();const i=[b,y].includes(e.key),n=t.getNextActiveElement(this._getChildren().filter((e=>!t.isDisabled(e))),e.target,i,!0);n&&(n.focus({preventScroll:!0}),j.getOrCreateInstance(n).show())}_getChildren(){return r.default.find(S,this._parent)}_getActiveElem(){return this._getChildren().find((t=>this._elemIsActive(t)))||null}_setInitialAttributes(t,e){this._setAttributeIfNotExists(t,"role","tablist");for(const t of e)this._setInitialAttributesOnChild(t)}_setInitialAttributesOnChild(t){t=this._getInnerElement(t);const e=this._elemIsActive(t),i=this._getOuterElement(t);t.setAttribute("aria-selected",e),i!==t&&this._setAttributeIfNotExists(i,"role","presentation"),e||t.setAttribute("tabindex","-1"),this._setAttributeIfNotExists(t,"role","tab"),this._setInitialAttributesOnTargetPanel(t)}_setInitialAttributesOnTargetPanel(e){const i=t.getElementFromSelector(e);i&&(this._setAttributeIfNotExists(i,"role","tabpanel"),e.id&&this._setAttributeIfNotExists(i,"aria-labelledby",`#${e.id}`))}_toggleDropDown(t,e){const i=this._getOuterElement(t);if(!i.classList.contains(A))return;const n=(t,n)=>{const s=r.default.findOne(t,i);s&&s.classList.toggle(n,e)};n(T,w),n(C,x),i.setAttribute("aria-expanded",e)}_setAttributeIfNotExists(t,e,i){t.hasAttribute(e)||t.setAttribute(e,i)}_elemIsActive(t){return t.classList.contains(w)}_getInnerElement(t){return t.matches(S)?t:r.default.findOne(S,t)}_getOuterElement(t){return t.closest(k)||t}static jQueryInterface(t){return this.each((function(){const e=j.getOrCreateInstance(this);if("string"==typeof t){if(void 0===e[t]||t.startsWith("_")||"constructor"===t)throw new TypeError(`No method named "${t}"`);e[t]()}}))}}return o.default.on(document,p,D,(function(e){["A","AREA"].includes(this.tagName)&&e.preventDefault(),t.isDisabled(this)||j.getOrCreateInstance(this).show()})),o.default.on(window,m,(()=>{for(const t of r.default.find(P))j.getOrCreateInstance(t)})),t.defineJQueryPlugin(j),j}(r(),c(),S(),w())}(qe);var Ve=qe.exports,Qe={exports:{}};
/*!
	  * Bootstrap toast.js v5.2.3 (https://getbootstrap.com/)
	  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(t,e){t.exports=function(t,e,i,n){const s=t=>t&&"object"==typeof t&&"default"in t?t:{default:t},o=s(e),r=s(i),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},E={animation:!0,autohide:!0,delay:5e3};class x extends r.default{constructor(t,e){super(t,e),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return E}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const e=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),t.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(e,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const t=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(t,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(t,e){switch(t.type){case"mouseover":case"mouseout":this._hasMouseInteraction=e;break;case"focusin":case"focusout":this._hasKeyboardInteraction=e}if(e)return void this._clearTimeout();const i=t.relatedTarget;this._element===i||this._element.contains(i)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(t=>this._onInteraction(t,!0))),o.default.on(this._element,u,(t=>this._onInteraction(t,!1))),o.default.on(this._element,d,(t=>this._onInteraction(t,!0))),o.default.on(this._element,f,(t=>this._onInteraction(t,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(t){return this.each((function(){const e=x.getOrCreateInstance(this,t);if("string"==typeof t){if(void 0===e[t])throw new TypeError(`No method named "${t}"`);e[t](this)}}))}}return n.enableDismissTrigger(x),t.defineJQueryPlugin(x),x}(r(),c(),w(),A())}(Qe);var Ke,Xe,Ye,Ue=Qe.exports;Ke=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Xe=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Ye=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Ke||Xe||Ye)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var t,e=location.hash.substring(1);/^[A-z0-9_-]+$/.test(e)&&(t=document.getElementById(e))&&(/^(?:a|select|input|button|textarea)$/i.test(t.tagName)||(t.tabIndex=-1),t.focus())}),!1),document.addEventListener("DOMContentLoaded",(()=>{new Swiper(".swiper",{loop:!0,grid:{rows:2,fill:"row"},slidesPerView:3,slidesPerColumn:2,slidesPerGroup:3,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),AOS.init(),gsap.registerPlugin(ScrollTrigger),ScrollTrigger.create({start:"top -1px",end:99999,toggleClass:{className:"main-tool-bar--scrolled",targets:".main-tool-bar"}}),function(){const t=document.querySelectorAll(".image-toggle"),e=document.querySelectorAll(".tab-image");t.forEach((i=>{i.addEventListener("click",(()=>{t.forEach((t=>t.classList.remove("active"))),i.classList.add("active"),e.forEach((t=>t.classList.remove("active")));const n=document.getElementById(i.classList[0]);n&&n.classList.add("active")}))}))}(),function(){let t=document.getElementById("team"),e=document.getElementById("individual"),i=document.querySelectorAll(".price");function n(t,e){t.classList.contains("active")||(t.classList.add("active"),e.classList.remove("active"),s())}function s(){t.classList.contains("active")&&i.forEach((t=>{t.classList.contains("team")?t.style.display="block":t.style.display="none"})),e.classList.contains("active")&&i.forEach((t=>{t.classList.contains("individual")?t.style.display="block":t.style.display="none"}))}t.addEventListener("click",(function(){n(t,e)})),e.addEventListener("click",(function(){n(e,t)})),s()}()})),t.Alert=T,t.Button=L,t.Carousel=I,t.Collapse=M,t.Dropdown=ve,t.Modal=ke,t.Offcanvas=Pe,t.Popover=Be,t.Scrollspy=ze,t.Tab=Ve,t.Toast=Ue,t.Tooltip=Re}));
