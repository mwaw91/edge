...
<!-- JS -->
<script type='text/javascript' src='https://skybox.gg/wp-content/themes/hello-elementor-child/edge-page/custom-javascript-71.js'></script>

<!-- Footer Start ============================================= -->
<footer id="colophon" class="site-footer clearfix" role="contentinfo">
    <div class="container">
        <div class="copyright">
            <span class="">Skybox Technologies ApSHQ Copenhagen</span> <span class="">DenmarkBus Reg: DK-39429063</span>
            <span class="text-center">Skybox Technologies ApSHQ Copenhagen DenmarkBus Reg: DK-39429063</span>
        </div>
        <!-- LOGO -->
